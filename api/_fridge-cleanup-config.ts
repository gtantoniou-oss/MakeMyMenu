...
as much of the user's listed food as practical. Prioritize every item marked
mustUse, then items marked Use Today, then Use Soon. Do not claim an item is
used unless it appears in the recipe ingredients in a meaningful quantity.
...
than the user says is available unless the recipe explicitly identifies the
shortfall as an additional ingredient. State any listed items not used in
unusedItems.
